...
###############################################################
        ...
        vcfPaths             => ["/labs/USC-ORIEN/VCF38/sarcoma", "/labs/USC-ORIEN/VCF38/bladder"],
       #AddOnly=>"crdc", 
###############################################################        
    ###  HOST INFORMATION  #### Easy is to make all the same location
###############################################################
	MongodbHost    => "10.48.66.234:24999",
...
###############################################################
	    ...
	    'structuralVariantFile' => {
                regex        => 'manta.somaticSV.pass.vcf.gz',
                valid        => 1,
                collectionDb => 'tumor'
            },
	    'copyNumberFile' => {
...
#######  AnnotateByGeneFields   ############                    
	    ...
	    'Cancer Mutation Census' =>1,
            ...
            'CGC_Tier' =>1,
            'CGC_Tumour Types(Somatic)' =>1, 
            'CGC_Tumor Types(Germline)' =>1,
            'CGC_Cancer Syndrome' =>1,
            'CGC_Molecular Genetics' =>1,
            'CGC_Role in Cancer' =>1,
            'CGC_Mutation Types' =>1,
	    'CNT' =>1,
            'codonpos' =>1,
            'codon_degeneracy' =>1,
            'COMMON' =>1,
            ...
            'gnomAD_exomes_AC' =>1,
            'gnomAD_exomes_AF' =>1,
            'gnomAD_exomes_AFR_AC' =>1,
            'gnomAD_exomes_AFR_AF' =>1,
            'gnomAD_exomes_AFR_AN' =>1,
            'gnomAD_exomes_AFR_nhomalt' =>1,
            'gnomAD_exomes_AMR_AC' =>1,
            'gnomAD_exomes_AMR_AF' =>1,
            'gnomAD_exomes_AMR_AN' =>1,
            'gnomAD_exomes_AMR_nhomalt' =>1,
            'gnomAD_exomes_AN' =>1,
            'gnomAD_exomes_ASJ_AC' =>1,
            'gnomAD_exomes_ASJ_AF' =>1,
            'gnomAD_exomes_ASJ_AN' =>1,
            'gnomAD_exomes_ASJ_nhomalt' =>1,
            'gnomAD_exomes_controls_AC' =>1,
            'gnomAD_exomes_controls_AF' =>1,
            'gnomAD_exomes_controls_AFR_AC' =>1,
            'gnomAD_exomes_controls_AFR_AF' =>1,
            'gnomAD_exomes_controls_AFR_AN' =>1,
            'gnomAD_exomes_controls_AFR_nhomalt' =>1,
            'gnomAD_exomes_controls_AMR_AC' =>1,
            'gnomAD_exomes_controls_AMR_AF' =>1,
            'gnomAD_exomes_controls_AMR_AN' =>1,
            'gnomAD_exomes_controls_AMR_nhomalt' =>1,
            'gnomAD_exomes_controls_AN' =>1,
            'gnomAD_exomes_controls_ASJ_AC' =>1,
            'gnomAD_exomes_controls_ASJ_AF' =>1,
            'gnomAD_exomes_controls_ASJ_AN' =>1,
            'gnomAD_exomes_controls_ASJ_nhomalt' =>1,
            'gnomAD_exomes_controls_EAS_AC' =>1,
            'gnomAD_exomes_controls_EAS_AF' =>1,
            'gnomAD_exomes_controls_EAS_AN' =>1,
            'gnomAD_exomes_controls_EAS_nhomalt' =>1,
            'gnomAD_exomes_controls_FIN_AC' =>1,
            'gnomAD_exomes_controls_FIN_AF' =>1,
            'gnomAD_exomes_controls_FIN_AN' =>1,
            'gnomAD_exomes_controls_FIN_nhomalt' =>1,
            'gnomAD_exomes_controls_NFE_AgnomAD_exomes_controls_NFE_AF' =>1,
            'gnomAD_exomes_controls_NFE_AN' =>1,
            'gnomAD_exomes_controls_NFE_nhomalt' =>1,
            'gnomAD_exomes_controls_nhomalt' =>1,
            'gnomAD_exomes_controls_POPMAX_AC' =>1,
            'gnomAD_exomes_controls_POPMAX_AF' =>1,
            'gnomAD_exomes_controls_POPMAX_AN' =>1,
            'gnomAD_exomes_controls_POPMAX_nhomalt' =>1,
            'gnomAD_exomes_controls_SAS_AC' =>1,
            'gnomAD_exomes_controls_SAS_AF' =>1,
            'gnomAD_exomes_controls_SAS_AN' =>1,
            'gnomAD_exomes_controls_SAS_nhomalt' =>1,
            'gnomAD_exomes_EAS_AC' =>1,
            'gnomAD_exomes_EAS_AF' =>1,
            'gnomAD_exomes_EAS_AN' =>1,
            'gnomAD_exomes_EAS_nhomalt' =>1,
            'gnomAD_exomes_FIN_AC' =>1,
            'gnomAD_exomes_FIN_AF' =>1,
            'gnomAD_exomes_FIN_AN' =>1,
            'gnomAD_exomes_FIN_nhomalt' =>1,
            'gnomAD_exomes_flag' =>1,
            'gnomAD_exomes_NFE_AC' =>1,
            'gnomAD_exomes_NFE_AF' =>1,
            'gnomAD_exomes_NFE_AN' =>1,
            'gnomAD_exomes_NFE_nhomalt' =>1,
            'gnomAD_exomes_nhomalt' =>1,
            'gnomAD_exomes_POPMAX_AC' =>1,
            'gnomAD_exomes_POPMAX_AF' =>1,
            'gnomAD_exomes_POPMAX_AN' =>1,
            'gnomAD_exomes_POPMAX_nhomalt' =>1,
            'gnomAD_exomes_SAS_ACgnomAD_exomes_SAS_AF' =>1,
            'gnomAD_exomes_SAS_AN' =>1,
            'gnomAD_exomes_SAS_nhomalt' =>1,
            'gnomAD_genomes_AC' =>1,
            'gnomAD_genomes_AF' =>1,
            'gnomAD_genomes_AFR_AC' =>1,
            'gnomAD_genomes_AFR_AF' =>1,
            'gnomAD_genomes_AFR_AN' =>1,
            'gnomAD_genomes_AFR_nhomalt' =>1,
            'gnomAD_genomes_AMI_AC' =>1,
            'gnomAD_genomes_AMI_AF' =>1,
            'gnomAD_genomes_AMI_AN' =>1,
            'gnomAD_genomes_AMI_nhomalt' =>1,
            'gnomAD_genomes_AMR_AC' =>1,
            'gnomAD_genomes_AMR_AF' =>1,
            'gnomAD_genomes_AMR_AN' =>1,
            'gnomAD_genomes_AMR_nhomalt' =>1,
            'gnomAD_genomes_AN' =>1,
            'gnomAD_genomes_ASJ_AC' =>1,
            'gnomAD_genomes_ASJ_AF' =>1,
            'gnomAD_genomes_ASJ_AN' =>1,
            'gnomAD_genomes_ASJ_nhomalt' =>1,
            'gnomAD_genomes_EAS_AC' =>1,
            'gnomAD_genomes_EAS_AgnomAD_genomes_EAS_AN' =>1,
            'gnomAD_genomes_EAS_nhomalt' =>1,
            'gnomAD_genomes_FIN_AC' =>1,
            'gnomAD_genomes_FIN_AgnomAD_genomes_FIN_AN' =>1,
            'gnomAD_genomes_FIN_nhomalt' =>1,
            'gnomAD_genomes_flag' =>1,
            'gnomAD_genomes_NFE_AgnomAD_genomes_NFE_AF' =>1,
            'gnomAD_genomes_NFE_AN' =>1,
            'gnomAD_genomes_NFE_nhomalt' =>1,
            'gnomAD_genomes_nhomalt' =>1,
            'gnomAD_genomes_POPMAX_AC' =>1,
            'gnomAD_genomes_POPMAX_AF' =>1,
            'gnomAD_genomes_POPMAX_AN' =>1,
            'gnomAD_genomes_POPMAX_nhomalt' =>1,
            'gnomAD_genomes_SAS_AC' =>1,
            'gnomAD_genomes_SAS_AF' =>1,
            'gnomAD_genomes_SAS_AgnomAD_genomes_SAS_nhomalt' =>1,
            'hg19_chr' =>1,
            'hg19_pos(1-based)' =>1,
            'HGVSc_ANNOVAR' =>1,
            'HGVSc_snpEff' =>1,
            'HGVSc_VEP' =>1,
            'HGVSp_ANNOVAR' =>1,
            'HGVSp_snpEffHGVSp_VEP' =>1,
            'Interpro_domain' =>1,
            'MinPopFreq' =>1,
            'MutationAssessor_pred' =>1,
            'MutationAssessor_rankscore' =>1,
            'MutationAssessor_score' =>1,
            'MutationTaster_AAE' =>1,
            'MutationTaster_converted_rankscore' =>1,
            'MutationTaster_model' =>1,
...
###############################################################   
        ...
        maxProcesses         => int(8),
        sync                 => 1,
        multipledVariant     => 0    # Allow multiple projectRuns per order
    };
